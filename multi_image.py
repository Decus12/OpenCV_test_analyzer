...
workbook = xlsxwriter.Workbook('tests_template.xlsx')
    ...
    for f in filenames:
        try:
            ...
            #Otherwise we find the maximum coordinates so we can draw C-lines location and crop original croped image from such a spot that C-line is never within it to find T-line correctly.
                ...
                clahe = cv2.createCLAHE(clipLimit=150.0, tileGridSize=(1,100))
                ...
                if locT == []:
                    ...
                    Tline = croped[int(top_leftT[1]*1.4):int(bottom_rightT[1]*0.8), top_leftT[0]:bottom_rightT[0]]
                ...
                Cline = croped[top_leftC[1]*1.4:bottom_rightC[1]*0.8, top_leftC[0]:bottom_rightC[0]]
